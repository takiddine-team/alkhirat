...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
    ...
    <div class="menu-item px-3">
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="symbol symbol-50px me-5">
                <img alt="Logo" src="{{(auth()->user()!=null) ? auth()->user()->avatar_url :''}}"/>
            </div>
            <!--end::Avatar-->
            ...
            <div class="d-flex flex-column">
                <div class="fw-bolder d-flex align-items-center fs-5">
                    ...
                    <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">مستفيد</span>
                </div>
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-5" data-bs-toggle="tooltip" data-bs-placement="left" title="{{ __('صفحة حسابك الشخصي') }}">
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-5" data-bs-toggle="tooltip" data-bs-placement="left" title="{{ __('صفحة الخدمات الخاصة بك') }}">
        <a href="{{ theme()->getPageUrl('settings.services') }}" class="menu-link px-5">
            {{ __('خدماتي') }}
        </a>
    </div>
    <!--end::Menu item-->
