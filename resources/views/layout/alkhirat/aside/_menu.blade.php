    ...
    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
        ...
        @hasrole('beneficiary')
            <div data-kt-menu-trigger="click"
                class="menu-item  {{ request()->is('account/settings*') ? 'show' : '' }} menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    ...
                    <div class="menu-item">
                        <a class="menu-link  {{ request()->is('account/settings/beneficiarie') ? 'active' : '' }}"
                    ...
                    <div class="menu-item">
                        <a class="menu-link  {{ request()->is('account/settings/skills') ? 'active' : '' }}"
                    ...
                    <div class="menu-item">
                        <a class="menu-link  {{ request()->is('account/settings/certificates') ? 'active' : '' }}"
                    ...
                    <div class="menu-item">
                        <a class="menu-link  {{ request()->is('account/settings/necessities') ? 'active' : '' }}"
                    ...
                    <div class="menu-item">
                        <a class="menu-link  {{ request()->is('account/settings/experiences') ? 'active' : '' }}"
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item  {{ request()->is('account/services') ? 'show' : '' }} menu-accordion">
                <span class="menu-link ">
                    <span class="menu-icon"></span>
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link  {{ request()->is('account/services') ? 'active' : '' }}"
        ...
        @hasrole('supporter')
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item  {{ request()->is('supporter/payments') || request()->is('supporter/contributions') ? 'show' : '' }} menu-accordion">
                <span class="menu-link ">
                    <span class="menu-icon"></span>
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item  {{ request()->is('supporter/membershiptypes') ? 'show' : '' }} menu-accordion">
                <span class="menu-link ">
                    <span class="menu-icon"></span>
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item  {{ request()->is('supporter/suggestion*') ? 'show' : '' }} menu-accordion">
                <span class="menu-link ">
                    <span class="menu-icon"></span>
            ...
            <div class="menu-item">
                <a class="menu-link  {{ request()->is('supporter/rightsDuties') ? 'active' : '' }}"
                    href="{{ route('supporter.rightsDuties') }}">
                    <span class="menu-icon"></span>
        ...
        @hasrole('volunteer')
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item {{ request()->is('volunteer/*') ? 'show' : '' }} menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon"></span>
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link  {{ request()->is('volunteer/volunteerLogs') ? 'active' : '' }}"
                            href="{{ theme()->getPageUrl('volunteer/volunteerLogs') }}">
                            <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
        ...
        @hasanyrole('admin')
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item {{ request()->is('beneficiaries') ? 'show' : '' }} menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon"></span>
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link {{ request()->is('beneficiaries') ? 'active' : '' }}"
                            href="{{ theme()->getPageUrl('beneficiaries') }}">
                            <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item {{ request()->is('supporters') ? 'show' : '' }}  menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon"></span>
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link {{ request()->is('supporters') ? 'active' : '' }}"
                            href="{{ theme()->getPageUrl('supporters') }}">
                            <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item {{ request()->is('volunteers') ? 'show' : '' }} menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon"></span>
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link {{ request()->is('volunteers') ? 'active' : '' }}"
                            href="{{ theme()->getPageUrl('volunteers') }}">
                            <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item {{ request()->is('services') ? 'show' : '' }} menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon"></span>
                    <span class="menu-title">الخدمات</span>
                    <span class="menu-arrow"></span>
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link {{ request()->is('services') ? 'active' : '' }}"
                            href="{{ theme()->getPageUrl('services') }}">
                            <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item {{ request()->is('admin/suggestion*') ? 'show' : '' }} menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon"></span>
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item  {{ request()->is('districts') || request()->is('influenceTypes') || request()->is('organizations') ? 'show' : '' }}  menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon"></span>
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link  {{ request()->is('districts') ? 'active' : '' }}"
                            href="{{ theme()->getPageUrl('districts') }}" data-bs-toggle="tooltip"
                    ...
                    <div class="menu-item">
                        <a class="menu-link  {{ request()->is('influenceTypes') ? 'active' : '' }}"
                            href="{{ theme()->getPageUrl('influenceTypes') }}">
                            <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                            <span class="menu-title">أنواع التأثير</span>
                        </a>
                    </div>
                    <div class="menu-item">
                        <a class="menu-link  {{ request()->is('organizations') ? 'active' : '' }}"
                            href="{{ theme()->getPageUrl('organizations') }}">
                            <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
        ...
        <div class="menu-item">
            <a class="menu-link {{ request()->is('projects') ? 'active' : '' }}"
        ...
        <div class="menu-item">
            <a class="menu-link {{ request()->is('activities') ? 'active' : '' }}"
        ...
        <div class="menu-item">
            <a class="menu-link {{ request()->is('contrib') ? 'active' : '' }}" href="{{ route('contrib.index') }}">
                <span class="menu-icon"></span>
        ...
        <div class="menu-item">
            <a class="menu-link {{ request()->is('payment-methods') ? 'active' : '' }}" href="{{ route('payment-methods.index') }}">
                <span class="menu-icon"></span>
        ...
        <div class="menu-item">
            <a class="menu-link {{ request()->is('service-types') ? 'active' : '' }}" href="{{ route('service-types.index') }}">
                <span class="menu-icon"></span>
