                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">المقدار المدفوع</th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $value->amount }} ريال</a>
                                    </td>
                                    <td>{{ $value->payment_method->name }}</td>
                                    <td><a target="_blank" href="{{ url(asset('storage/attachments/payments/'.$value->attachment)) }}" >{{ $value->attachment }} </a></td>
                                    <td>{{ $value->note }}</td>
                                </tr>
                                @endforeach
