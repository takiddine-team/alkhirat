                    ...
                    <div class="flex-lg-row-fluid ms-lg-7 ms-xl-12">
                        <div class="card">
                            <div class="card-header align-items-center py-5 gap-5">
                                <div class="d-flex">
                                    <a href="{{ url('admin/suggestions') }}" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Archive">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('admin/suggestion') }}" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Next message">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-50 me-4">
                                                <div class="symbol symbol-35px me-3">
                                                    <div class="symbol-label bg-light-danger">
                                                        <span class="text-danger"><?php echo substr($suggestion->infoReceiver->user->first_name, 0, 2); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Avatar-->
                                            <div class="pe-5">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap gap-1">
                                                    <a href="#" class="fw-bolder text-dark text-hover-primary">{{ $suggestion->infoReceiver->user->first_name.' '.$suggestion->infoReceiver->user->last_name }}</a>
