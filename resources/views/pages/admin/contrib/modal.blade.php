...
<div class="modal fade" id="kt_modal_{{ $_content ? 'edit' : 'add' }}_customer" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <form class="form" method="POST" enctype="multipart/form-data" action="{{ is_null($_content) ? route('contrib.store') : route('contrib.update', $_content?->id) }}"
                ...
                <div class="modal-header" id="kt_modal_add_customer_header">
                    <h2 class="fw-bolder">
                        {{ is_null($_content) ? 'مساهمة جديدة' : 'تعديل المساهمة'}}
                    </h2>
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fs-6 fw-bold mb-2">الملاحظة</label>
                            <input type="text" class="form-control form-control-solid"
                                name="note" value="{{ old('note', $_content?->note) }}" />
                        </div>
