...
<div class="modal fade" id="kt_modal_{{ $_content ? 'edit' : 'add' }}_customer" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <form class="form" method="POST" enctype="multipart/form-data" action="{{ is_null($_content) ? route('payment-methods.store') : route('payment-methods.update', $_content?->id) }}"
                ...
                <div class="modal-header" id="kt_modal_add_customer_header">
                    <h2 class="fw-bolder">
                        {{ is_null($_content) ? 'طريقة دفع جديدة' : 'تعديل طريقة الدفع'}}
                    </h2>
