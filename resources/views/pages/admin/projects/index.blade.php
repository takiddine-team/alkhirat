                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_add_customer">مشروع جديد</button>
                                <!--end::Add customer-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach ($projects as $project)
                                    <tr>
                                        ...
                                        <td class="">
                                            <a href="{{ route('projects.edit', compact('project')) }}" class="btn btn-primary edit-btn">تعديل</a>
                                            <a href="{{ route('projects.show', compact('project')) }}" class="btn btn-primary">تفاصيل</a>
