                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach ($activities as $activity)
                                    <tr>
                                        ...
                                        <td class="">
                                            <a href="{{ route('activities.edit', $activity->id) }}" class="btn btn-primary edit-btn">تعديل</a>
                                            <a href="{{ route('activities.show', $activity->id) }}" class="btn btn-primary">تفاصيل</a>
