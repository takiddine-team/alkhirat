                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            ...
                                            <form id="kt_modal_add_user_form" class="form" action="{{ route('users.store') }}" method="POST">
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        <label class="required fw-bold fs-6 mb-2">الحي</label>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="badge badge-light fw-bolder">
                                                {{ $user->last_login_at?->diffForHumans() ?? 'لم يتم تسجيل الدخول بعد' }}
                                            </div>
                                        </td>
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('users.edit', $user->id)}}"
                                                        class="menu-link px-3 edit-btn">تعديل</a>
                                                </div>
                                                <div class="menu-item px-3">
