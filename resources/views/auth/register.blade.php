<x-auth-layout>
    ...
    <!--begin::Heading-->
        ...
        <div class="d-flex align-items-center mb-10">
            ...
            <span class="fw-bold text-gray-400 fs-7 mx-2">{{ __('أو') }}</span>
            <div class="border-bottom border-gray-300 mw-50 w-100"></div>
        </div>
        <!--end::Separator-->
        ...
        <div class="row fv-row mb-7">
            <!--begin::Col-->
            <div class="col-xl-6">
                <label class="form-label fw-bolder text-dark fs-6">{{ __('الاسم الأول') }}</label>
            ...
            <!--begin::Col-->
            <div class="col-xl-6">
                <label class="form-label fw-bolder text-dark fs-6">{{ __('الاسم الأخير') }}</label>
        ...
        <div class="fv-row mb-7">
            <label class="form-label fw-bolder text-dark fs-6">{{ __('البريد الالكتروني') }}</label>
        ...
        <div class="fv-row mb-5">
            <label class="form-label fw-bolder text-dark fs-6">{{ __('تأكيد الرقم السري') }}</label>
        ...
        <div class="fv-row mb-10">
            <label class="form-check form-check-custom form-check-solid form-check-inline">
                ...
                {{ __('أنا موافق على قبول') }} <a href="#" class="ms-1 link-primary">{{ __('الشروط والأحكام') }}</a>.
            </span>
            </label>
        </div>
        <!--end::Input group-->
